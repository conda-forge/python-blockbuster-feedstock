About python-blockbuster-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-blockbuster-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-blockbuster-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-blockbuster
# for installing globally
pixi global install python-blockbuster
```
...
It is possible to list all of the versions of `python-blockbuster` available on your platform:
...
```
pixi search python-blockbuster --channel conda-forge
```
